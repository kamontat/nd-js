...
export const NETWORK_FAIL_ERR: Throwable = new FError("Your connection is not established", 10);
export const SECURITY_FAIL_ERR: Throwable = new FError("You key is not pass security condition", 11);
